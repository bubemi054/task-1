...
describe("uiSlice reducer", () => {
  ...
  it("should update searchCityText", () => {
    const newState = reducer(
      initialState,
      uiActions.changeSearchCityText("Lagos"),
    );
  ...
  it("should update favoriteCitiesId", () => {
    ...
    const newState = reducer(
      initialState,
      uiActions.changeFavoriteCitiesId(newFavorites),
    );
  ...
  it("should update removedCitiesId", () => {
    ...
    const newState = reducer(
      initialState,
      uiActions.changeRemovedCitiesId(removedIds),
    );
  ...
  it("should toggle showRemovedCities", () => {
    ...
    const toggledBackState = reducer(
      newState,
      uiActions.toggleShowRemovedCities(),
    );
  ...
  it("should update showRemovedCities to a specific value", () => {
    const newState = reducer(
      initialState,
      uiActions.changeShowRemovedCities(true),
    );
    expect(newState.showRemovedCities).toBe(true);
  });
});
